...
constexpr SettingsMessageTree s_contributorsChildren[4] = {SettingsMessageTree(I18n::Message::AxelMontlahuc), SettingsMessageTree(I18n::Message::Andrei), SettingsMessageTree(I18n::Message::UpsilonTeam), SettingsMessageTree(I18n::Message::OmegaTeam)};
